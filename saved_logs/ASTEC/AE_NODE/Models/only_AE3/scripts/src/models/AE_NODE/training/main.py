...
def main():
    ...
    shutil.copytree('src', os.path.join(config_training['PATH'], 'scripts/src'), dirs_exist_ok=True)

    # Still need individual copies for other files
    shutil.copy('bin/main.py', config_training['PATH']+'/scripts/bin/')
    ...
    #define the model
    module_name = 'src.models.'+str(config_training['model'])+'.'+str(config_training['model'])+'_model'
