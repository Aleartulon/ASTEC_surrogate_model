...
from src.models.ASTEC_surrogate.ASTEC_surrogate_model import ASTEC_surrogate

class Training(ASTEC_surrogate):
    def __init__(self, astec_instance):
        
        from src.models.ASTEC_surrogate.method_functions import Training_Losses
