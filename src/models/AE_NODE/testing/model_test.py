...
class Model_Test:
    ...
    def generate_pictures_fields(self, trajectory_to_be_plotted:str, reconstructed_fields_per_trajectory:dict, denormalized_fields_per_trajectory:dict, Time:dict, which_prediction: str):
        ...
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 4 ,field_name = 'Q_fp_Ac', ylabel =  'm Q fp Ac H2', figsize=(5, 5), fontsize=16)
        ...
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 18 ,field_name = 'Q_fp_Gd', ylabel =  'Q fp Gd', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index =19 , field_name = 'Q_fp_Ge', ylabel = 'Q fp Ge', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 20 , field_name = 'Q_fp_Ho', ylabel = 'Q fp Ho', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 21 , field_name = 'Q_fp_I', ylabel = 'Q fp I', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 22 ,field_name = 'Q_fp_ln', ylabel =  'Q fp ln', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 23 , field_name = 'Q_fp_Kr', ylabel = 'Q fp Kr', figsize=(5, 5), fontsize=16)
        
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 24 ,field_name = 'Q_fp_La', ylabel =  'Q fp La', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index =25 , field_name = 'Q_fp_Mo', ylabel = 'Q fp Mo', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 26 , field_name = 'Q_fp_Nb', ylabel = 'Q fp Nb', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index =27 , field_name = 'Q_fp_Nd', ylabel = 'Q fp Nd', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 28 ,field_name = 'Q_fp_Np', ylabel =  'Q fp Np', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index =29 , field_name = 'Q_fp_Pa', ylabel = 'Q fp Pa', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 30 , field_name = 'Q_fp_Pd', ylabel = 'Q fp Pd', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index =1 , field_name = 'Q_fp_Pm', ylabel = 'Q fp Pm', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 32 ,field_name = 'Q_fp_Pr', ylabel =  'Q fp Pr', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index =33 , field_name = 'Q_fp_Pu', ylabel = 'Q fp Pu', figsize=(5, 5), fontsize=16)
        
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 34 ,field_name = 'Q_fp_Ra', ylabel =  'Q fp Ra', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index =35 , field_name = 'Q_fp_Rb', ylabel = 'Q fp Rb', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 36 , field_name = 'Q_fp_Re', ylabel = 'Q fp Re', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index =37 , field_name = 'Q_fp_Rh', ylabel = 'Q fp Rh', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 38 ,field_name = 'Q_fp_Ru', ylabel =  'Q fp Ru', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 39 , field_name = 'Q_fp_Sb', ylabel = 'Q fp Sb', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 40 , field_name = 'Q_fp_Se', ylabel = 'Q fp Se', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 41 , field_name = 'Q_fp_Sm', ylabel = 'Q fp Sm', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 42 ,field_name = 'Q_fp_Sn', ylabel =  'Q fp Sn', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 43 , field_name = 'Q_fp_Sr', ylabel = 'Q fp Sr', figsize=(5, 5), fontsize=16)
        
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 44 ,field_name = 'Q_fp_Tb', ylabel =  'Q fp Tb', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 45 , field_name = 'Q_fp_Tc', ylabel = 'Q fp Tc', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 46 , field_name = 'Q_fp_Te', ylabel = 'Q fp Te', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 47 , field_name = 'Q_fp_Th', ylabel = 'Q fp Th', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 48 ,field_name = 'Q_fp_Tl', ylabel =  'Q fp Tl', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 49 , field_name = 'Q_fp_Xe', ylabel = 'Q fp Xe', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 50 , field_name = 'Q_fp_Y', ylabel = 'Q fp Y', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 51 , field_name = 'Q_fp_Yb', ylabel = 'Q fp Yb', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 52 ,field_name = 'Q_fp_Zn', ylabel =  'Q fp Zn', figsize=(5, 5), fontsize=16)
        self.plot_scalar_values(trajectory_to_be_plotted, Time, reconstructed_fields_per_trajectory, denormalized_fields_per_trajectory, which_prediction, shape_index = 0, variable_index = 53 , field_name = 'Q_fp_Zr', ylabel = 'Q fp Zr', figsize=(5, 5), fontsize=16)
