...
def main():
    ...
    if config_training['dynamic_dataset_generation_during_training']:
        raise TypeError('dynamic_dataset_generation_during_training must be set to false for ONLY_DECODER')
    ...
    shutil.copytree('src/models/ONLY_DECODER/training', os.path.join(config_training['PATH'], 'scripts/src'), dirs_exist_ok=True)
